...
const AddCourse = () => {
  ...
  // Handle lecture actions (add)
  const handleLecture = (chapterId) => {
    ...
    <div className="h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0">
      ...
      <form className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        {chapters.map((chapter, chapterIndex) => (
          <div key={chapter.chapterId} className="mb-4 p-4 border rounded-md">
            ...
            {!chapter.collapsed && (
              <div className="p-4">
                ...
                <div
                  ...
                  onClick={() => handleLecture(chapter.chapterId)}
                >
                  + Add Lecture
                </div>
              </div>
        ...
        {showPopup && (
          <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
            <div className="bg-white text-gray-500 p-4 rounded relative w-full max-w-80">
